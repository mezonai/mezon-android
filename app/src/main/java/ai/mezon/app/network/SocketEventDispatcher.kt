...
import com.mezon.mezon.rtapi.HandleParticipantMeetStateEvent
...
/**
 * Fans out raw [Envelope] events from [MezonSocket] into typed [SharedFlow]s.
 * StateHolders and ViewModels collect from these flows to update their state.
 *
 * Mirrors the event handlers in mezon-js socket.ts (onchannelmessage, onvoicejoined, etc.)
 */
@Singleton
class SocketEventDispatcher @Inject constructor(
    mezonSocket: MezonSocket,
    ...
    // ── Init: collect raw events and dispatch ────────────────────
