...
class CallAvatarView(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(w, avatarSize + LayoutHelper.dp(80))
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val nameY = avatarTop + avatarSize + LayoutHelper.dp(24)
        canvas.drawText(peerName, cx, nameY, namePaint)

        if (statusText.isNotEmpty()) {
            canvas.drawText(statusText, cx, nameY + LayoutHelper.dp(24), statusPaint)
        }
    }
