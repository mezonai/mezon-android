...
class CallingOverlay(context: Context) : FrameLayout(context) {
    ...
    init {
        ...
        row.addView(avatarView, LinearLayout.LayoutParams(LayoutHelper.dp(44), LayoutHelper.dp(44)))
        ...
        val btnDim = LayoutHelper.dp(52)

        pillWrap.addView(
            VoiceStyleCircleButton(context, MezonIcon.callCancelIcon, VoiceChrome.RED_STRONG, 0, 0xFFFFFFFF.toInt(), VoiceStyleCircleButton.END_CALL_ICON_SIZE).apply {
        ...
        pillWrap.addView(
            VoiceStyleCircleButton(context, MezonIcon.phoneCallIcon, tc.onlineGreen, 0, 0xFFFFFFFF.toInt(), VoiceStyleCircleButton.END_CALL_ICON_SIZE).apply {
